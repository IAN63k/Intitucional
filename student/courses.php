    ...
    <main>
        ...
        <div class="container">
                ...
                <div class="opt">
                    <div id="user_profile">
                        ...
                        <div class="profile_border">
                            <img src="<?php $result = mysqli_query($mysqli, "SELECT * from estudiantes WHERE id = '" . $_SESSION["id"] . "' ");
            ...
            <div class="house">
                ...
                <a href="./coursesDetails.php">*Selecione para ver sus calificaciones</a>
            </div>
            <div class="second-content content_scnd"><br>
                <?php
                $result = mysqli_query($mysqli, "SELECT * from notas,asignaturas WHERE notas.id_estudiante='" . $_SESSION["id"] . "' AND  asignaturas.id_asignatura=notas.id_asig ");
                while ($datos = mysqli_fetch_assoc($result)) {
