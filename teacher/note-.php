...
<head>
    ...
    <title>Mis notas/ promedio</title>
    <?php
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="house courses">
                ...
                <button type='submit'  name='btn-save' >Exportar</button>
            ...
            <div class="second-content" id='reload'><br>
                ...
                $c5 = 0;
                $c6 = 0;
                $cant =  mysqli_num_rows(mysqli_query($mysqli, "SELECT * from notas WHERE id_asig='" . $_SESSION["asig"] . "' "));
                ...
                while ($datos = mysqli_fetch_assoc($result2)) {
                    ...
                    $c3 += $datos["corte_3"];
                    $c4 += $datos["proyecto"];
                    $c5 += $datos["adicionales"];
                    $c6 += $datos["notaFinal"];
                }
                    echo "
                             <tr>
                                        <td><input type='text' value='" . $c1/$cant . "' class='modal-input' disabled></td>
                                        <td><input type='text' value='" . $c2/$cant . "'  class='modal-input' disabled></td>
                                        <td><input type='text' value='" . $c3/$cant . "'  class='modal-input' disabled></td>
                                        <td><input type='text' value='" . $c4/$cant . "'  class='modal-input' disabled></td>
                                        <td><input type='text' value='" . $c5/$cant . "'  class='modal-input' disabled></td>
                                        <td><input type='text' value='" . $c6/$cant . "'  class='modal-input' disabled></td>
