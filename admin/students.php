    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="principal-content">
                ...
                <p>Estudiantes <button type="submit" name="optionshbtn" class="optionshbtn"><a href="./editStudents.php">Opciones</a></button>
                    <br>
                    <br>
                <form action="#" method="POST">
                    <input type="text" class="input" placeholder="Buscar docente por cedula: " name="search">
