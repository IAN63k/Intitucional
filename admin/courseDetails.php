    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="principal-content">
                ...
                <p>Asignaturas <button type="submit" name="optionshbtn" class="optionshbtn"><a href="./addcourse.php">Opciones</a></button>
                    <br>
                    <br>
            ...
            if (empty($_POST)) {
                ...
                $result = mysqli_query($mysqli, "SELECT * from docentes  ORDER BY nombre ASC");
                while ($datos = mysqli_fetch_assoc($result)) {
                    ...
                    echo "
                            <tr>
                                    ...
                                    <td>" . $datos['id'] . "</td>
                                    <td>";
                    $result2 = mysqli_query($mysqli, "SELECT * from asignatura WHERE  id_docente = '" . $datos["id"] . "'  ORDER BY asig_nombre ASC");
                    while ($datos2 = mysqli_fetch_assoc($result2)) {
                        echo "" . $datos2["asig_nombre"] . "<br>";
                    }
                    echo "</td>
                                    <td>";
                    $result3 = mysqli_query($mysqli, "SELECT * from asignatura,grupos WHERE  grupos.id_gp =  asignatura.id_grupo AND asignatura.id_docente = '" . $datos["id"] . "'  ORDER BY grupos.grupo ASC");
                    while ($datos3 = mysqli_fetch_assoc($result3)) {
                        echo "" . $datos3["grupo"] . "<br>";
                    }
                    echo "</td>
                            </tr>
                        ";
                    ...
                    while ($datos = mysqli_fetch_assoc($result)) {
                        ...
                        echo "
                                <tr>
                                        ...
                                        <td>" . $datos['id'] . "</td>
                                        <td>";
                        $result2 = mysqli_query($mysqli, "SELECT * from asignatura WHERE  id_docente = '" . $datos["id"] . "'");
                        while ($datos2 = mysqli_fetch_assoc($result2)) {
                            echo "" . $datos2["asig_nombre"] . "<br>";
                        }
                        echo "</td>
                                        <td>";
                        $result3 = mysqli_query($mysqli, "SELECT * from asignatura,grupos WHERE  grupos.id_gp =  asignatura.id_grupo AND asignatura.id_docente = '" . $datos["id"] . "'");
                        while ($datos3 = mysqli_fetch_assoc($result3)) {
                            echo "" . $datos3["grupo"] . "<br>";
                        }
                        echo "</td>
