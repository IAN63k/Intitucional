    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="principal-content">
                <p>Estudiantes:</p>
                <button type="submit" name="optionshbtn" class="optionshbtn"><a href="./addToClass.php">Añadir a clases</a></button>
                <div class="refresh">
                ...
                <form action="#" method="POST">
                    <input type="text" class="input" placeholder="Buscar estudiante por cedula: " name="search">
                    <button type="submit" name="searchbtn" class="searchbtn">Buscar</button>
                    <div class="div-add"><button class="btn-add" name="btn-add"><img src="../img/add-user.svg" alt="Añadir estudiante">
                            <figcaption>Añadir estudiante</figcaption>
                        </button>
                    </div>
                </form>
            ...
            ";
                ...
                if (isset($_POST["btn-delete"])) {
                    $id = $_POST["tb-id"];
                    mysqli_query($mysqli, "DELETE FROM estudiantes where id='$id'");
                }
                ...
                if (isset($_POST["update-btn"])) {
                    ...
                    if (!empty($nombre) || !empty($id) || !empty($email) || !empty($password)) {
                        ...
                        $querry =  mysqli_query($mysqli, "UPDATE estudiantes SET nombre='$nombre', id='$id', email='$email', contraseña='$password' WHERE id=" . $_POST['modal-id-hidden'] . " ");
                        echo "<script>alert('Actualizado, porfavor refresque la pagina.')</script>";
                    } else {
                ...
                if (isset($_POST["update-btn-add"])) {
                    ...
                    if (!empty($nombre) || !empty($id) || !empty($email) || !empty($password)) {
                        #Si no estan vacios ejecuta el Update
                        $querry =  mysqli_query($mysqli, "INSERT INTO estudiantes (nombre, id, email, contraseña, profile, id_rol ) VALUES ('$nombre', '$id', '$email', '$password', '', '3'); ");
